...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int indicatorColor = 0x9AFF0000;
	private int underlineColor = 0x9AFF0000;
	...
	private int tabTextColor = 0x9AFFFFFF;
   ...
   private int tabDeactivateTextColor = 0xFFCCCCCC;
	...
	tabTextColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsActivateTextColor, tabTextColor);
		...
		String fontPath = "font/Sansation_Regular.ttf";
		tabTypeface= Typeface.createFromAsset(context.getAssets(), fontPath);
		a.recycle();
